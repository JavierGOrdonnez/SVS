...
| T23 | . | Add rich visualizations for extracted data — feminicides tab: stacked bar chart (age groups x-axis, origin breakdown per bar: víctimas españa + víctimas otro país); no rate subtitles (rates deferred to T24). Extend other tabs with existing visualizations | I.*,V1,V6 |
