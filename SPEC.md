...
| T11 | ~ | Populate `data/raw/migration_spain.csv` (129 rows) — flows 2000-2024 (INE EVR/EM/EMCR via Eurostat cross-check), foreign-nationality stock 2000-2025 (Padrón→ECP table 56936), top-10 origin nationalities for 2024 inflow & 2025 stock, sex-split 2021-2024 inflow & 2025 stock, 19-bucket age-group breakdown of 2024 inflow (sum=1288562 ✓), SS-affiliation 2024 Régimen General + RETA. PENDING: top 4-10 for years pre-2023, age-group breakdown pre-2024, annual MISSM by Régimen 2000-2024 (OPI WAF-blocked), stock foreign-born series 2003-2024 except wiki cites. See `data/sources/migracion_espana.md` | V10,C8 |
