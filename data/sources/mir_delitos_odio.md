...
8. **2024 −13.8% total dip: the Ministry itself attributed it to suppressed reporting, in an earlier statement dropped from the final report.** The final 18/07/2025 nota de prensa (used as `source_url` above) is purely descriptive of the 2024 figures, with no causal claim. But at the 24/03/2025 presentation of provisional 2024 data (III Plan de Acción launch), Interior officials went further — confirmed directly from El País (Óscar López-Fonseca/Juana Viúdez, 24 Mar 2025, https://elpais.com/espana/2025-03-24/interior-atribuye-a-los-mensajes-politicos-xenofobos-el-descenso-de-denuncias-por-delitos-de-odio.html): "Los primeros análisis apuntan a que buena parte de la caída está motivada por los mensajes con tintes xenófobos de algunos partidos políticos... Fuentes de Interior consideran que 'la presión social' que estas manifestaciones suponen 'disuade de la denuncia' a muchas víctimas." Minister Grande-Marlaska is quoted making the same point without naming a party. The article also notes "todos los expertos consideran que existe una tasa de infradenuncia muy elevada" (only ~1 in 10 victims reports, per EU/Spain studies cited) and that "este descenso preocupa a los expertos policiales, que han comenzado a estudiar sus causas" — i.e. the drop worried Interior's own analysts enough to prompt an internal causes review, the outcome of which is not published anywhere found so far. **Net read: the Ministry's own working hypothesis is a reporting-suppression effect, not a real decline in incidents** — this is a primary-source claim (Interior officials, on record), not an NGO inference, though it is itself unverified/associative (V18, C2) and never appeared in the final report's own text. Corroborating signal, also primary-sourced: Fiscalía General del Estado's *Memoria Anual 2025* (covering FY2024), ch. III.10.4 (https://www.fiscal.es/memorias/memoria2025/FISCALIA_SITE/capitulo_III/cap_III_10_4.html) shows *escritos de acusación* (indictments) for hate/discrimination offences UP ~40% in 2024 (210→293) even as MIR's police-recorded total fell 13.8% — a judicial-stage metric moving opposite the police-recorded headline in the same year, though these measure different funnel stages (prosecutions on cases opened in prior years vs newly recorded incidents) and are not directly comparable without more work (see T98). Fiscalía's own earlier-stage *diligencias de investigación preprocesal* fell more modestly than MIR's total: 511→477 (−6.7%) vs MIR's −13.8%.

## Candidate additional sources — civil-society/watchdog reactions to the 2024 dip (not yet fetched/parsed, see T97/T98)

Surfaced 2026-08-01 while researching why the MIR 2024 report shows a −13.8%
YoY total (2268→1955). The Ministry's own press release/PDF is descriptive
only (no causal explanation for the dip); these NGO/academic sources were
found via that research pass and are worth mining once T97/T98 land, per the
user's explicit direction to keep building on them once the police/Interior
data itself has been fully processed and investigated:

| Source | What it is | Why relevant | Link |
|---|---|---|---|
| Felgtbi+ "Estado del Odio LGTBI+" (2024/2025/2026 editions) | Annual independent victimization survey (~800 interviews via 40dB pollster), co-authored with CSIC's Instituto de Políticas y Bienes Públicos | Survey-measured LGTBI+ victimization keeps *rising* (harassment 20%→36%, discrimination 23%→29%, aggression 7%→22% over "the last two years") opposite the police-recorded 2024 dip; formal-complaint rate to authorities roughly doubled "since 2024" (17%→35%) — a direct reporting-rate lead | https://felgtbi.org/wp-content/uploads/2024/08/Informe-DDOO_24.pdf, https://felgtbi.org/wp-content/uploads/2025/05/Estado-LGTBI-Estado-odio-2025.pdf |
| El País, "Interior atribuye a los mensajes políticos xenófobos el descenso de denuncias por delitos de odio" (24 Mar 2025) | Primary-source news report of Interior's own 24/03/2025 provisional-data presentation (III Plan de Acción launch) | **CONFIRMED, see caveat 8 above** — direct on-record quotes from Interior sources and Grande-Marlaska attributing the 2024 dip to reporting suppression from normalized xenophobic political rhetoric; states Interior's own analysts were concerned enough to open an internal causes review (outcome not yet located) | https://elpais.com/espana/2025-03-24/interior-atribuye-a-los-mensajes-politicos-xenofobos-el-descenso-de-denuncias-por-delitos-de-odio.html |
| Fiscalía General del Estado, Memoria Anual 2025 (covers FY2024), ch. III.10.4 "Delitos de Odio y Discriminación" | Annual prosecutorial-service report | **CONFIRMED, see caveat 8 above** — escritos de acusación (indictments) for hate/discrimination offences up ~40% (210→293) even as MIR's police-recorded total fell 13.8%; sentencias +11% (173 total, 129 condenatorias/74.5%); counter-note: earlier-stage diligencias de investigación preprocesal fell more mildly, 511→477 (−6.7%). Funnel-stage mismatch vs MIR (T98 caveat) means this is not a like-for-like contradiction, just a real, sourced divergence worth reconciling | https://www.fiscal.es/memorias/memoria2025/FISCALIA_SITE/capitulo_III/cap_III_10_4.html (PDF: https://www.fiscal.es/documents/20142/133838/MEMFIS25.pdf) |
| Movimiento contra la Intolerancia — closed lead for 2024 specifically | Spain's oldest anti-hate-crime NGO; publishes "Informe Raxen Especial" + INFORAXEN (daily monitoring service) | Checked (2026-08-01): no "Informe Raxen Especial 2024" found published (last is the 2023 edition, 28 Feb 2024); no MCI/Esteban Ibarra statement located specifically about the 2024 −13.8% figure — their public commentary on infradenuncia ("solo se está denunciando entre el 20% y el 25% de los hechos") is from a June 2026 interview about the *2025* report's +23.6%/+86.5%-antisemitism spike, not 2024. Genuine gap, not yet a source to mine — re-check if a 2024 Raxen edition surfaces later | https://www.informeraxen.es/, http://www.estebanibarra.com/ |
| Observatorio de Antisemitismo (FCJE) | Runs INFORAXEN-fed antisemitism-specific monitoring, publishes its own reports | Antisemitism was the fastest-*rising* MIR ámbito in 2024 (+60.9%) — cross-check their independent count against MIR's; not yet checked | https://observatorioantisemitismo.fcje.org/publicaciones/ |
| ONDOD "Informe de la encuesta sobre delitos de odio (2024)" | The Ministry's own new (2025-launched) victim/witness survey, explicitly designed to estimate the "cifra negra" (dark figure) beyond hechos denunciados | Direct primary-source companion to the police-recorded series discussed above (see main §Critical caveats); not yet fetched/parsed here | https://cpage.mpr.gob.es/publicacion/informe-de-la-encuesta-sobre-delitos-de-odio-2024-2025-126250197-0000/, PDF: https://oficinanacional-delitosdeodio.ses.mir.es/publico/ONDOD/dam/jcr:c4c5d5f0-65e8-45d8-be5f-73d1654cbe43/ONDOD_Informe_encuesta_2024.pdf |
| OBERAXE (Observatorio Español del Racismo y la Xenofobia) | Ministerio de Inclusión unit; publishes racism/xenophobia monitoring + hosts the Giménez-Salinas Framis et al. 2023 sentencing study already cited above | General racism/xenophobia-specific angle, separate from ONDOD's cross-ámbito remit; also republished the Fiscalía memoria finding above | https://www.inclusion.gob.es/web/oberaxe/ |
| El Diario Euskadi (24 Jun 2026), Ertzaintza 2025 hate-incident drop | Regional parallel case, not national MIR data | Basque hate-incident count fell 236→193 (2024→2025); academics quoted explicitly invoke cifra negra/infradenuncia to caution against reading the fall as real — same skeptical framing as the reporting-rate hypothesis here, different year-pair and dataset (regional Ertzaintza, not MIR national) | eldiario.es/euskadi, 24/06/2026 (exact URL not re-verified, found via agent search) |

Fetched/verified so far: the El País and Fiscalía rows above (both primary,
2026-08-01 research pass). Everything else in this table is still an
unprocessed lead — source-discovery log only, per V18's mandate to
prioritize established watchdog organizations. See T97 (remaining
fetch/read pass) and T98 (reporting-rate-hypothesis test against the 2024
dip) in
`SPEC-crime.md`.
