...
| T37 | ~ | Collect hate-speech-watchdog datasets (RAXEN, SOS Racismo) & primary source data (Interior/Fiscalía/INE) on hate-crimes/incidents (racism/xenophobia 2025 spike). LGTBI-phobia (OSIG ámbito) slice done 2013–2025: `data/sources/lgtbifobia_espana.md` — victim/aggressor sex crosstabs category-specific & reliable 2021–2023; all-categories nationality table primary-verified 2021–2024; OSIG-specific nationality crosstab confirmed **absent at national level**, but two independent partial measurements (Andalucía 2020 police data, Giménez-Salinas Framis 2018-2022 judicial sentencing study) both show aggressors majority Spanish (87.5%/69.2%), against the "immigrant-driven increase" claim. | V18 |
