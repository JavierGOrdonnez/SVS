...
| `src/feminicides/compute_feminicide_rates.py` | `feminicidios_delegacion_2003-2026.json` (2006-2024 reports), `population_spain_midyear_5yr.csv`, `migration_spain.csv` (foreign-resident stock) | `data/processed/feminicide_rates_2006-2024.csv` | T24 | x |
...
| `src/feminicides/build_dashboard_data.py` | `feminicidios_delegacion_2003-2026.json`, `feminicide_rates_2006-2024.csv` (latest year selected) | `build()` consumed by `src/analysis/build_dashboard.py` → `docs/data/feminicides.json` | T23,T24 | x |
