...
| T23 | . | Add rich visualizations for extracted data — extend dashboard tabs: per-region heatmaps (feminicide 2003–2026), per-age breakdowns (femicide victim/perpetrator), per-origin trends (national vs foreign victims/perpetrators), category trends (sexual crime types 2000–2024), Macroencuesta prevalence overlay | I.*,V1,V6 |
