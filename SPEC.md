...
| T37 | ~ | Collect hate-speech-watchdog datasets (RAXEN, SOS Racismo) & primary source data (Interior/Fiscalía/INE) on hate-crimes/incidents (racism/xenophobia 2025 spike). LGTBI-phobia (OSIG ámbito) slice done 2013–2025: `data/sources/lgtbifobia_espana.md` — victim/aggressor sex crosstabs category-specific & reliable 2021–2023; nationality crosstab confirmed **absent at national level** (only Andalucía 2020 regional exception found). | V18 |
